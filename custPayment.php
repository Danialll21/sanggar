...
if(isset($_POST['send'])){
    ...
    {
        $sql="DELETE FROM ".$_SESSION['table'];
        $val= $db->query($sql);
        header("location:success.php");
    } elseif($amount < $totalPayment) {
        $_SESSION['message'] = "Insufficient amount of money!";
    } else {
        $sql="DELETE FROM ".$_SESSION['table'];
        $val= $db->query($sql);
        header("location:success.php");
...
<div id="order" class="bg-1">
      ...
      <div class="modal-content">
        ...
        <form method="POST">
              <label for="psw"><span class=""></span>Please Enter Amount Of Money: </label>
        ...
        <div class="modal-footer">
            <a href="custCart.php" class="btn btn-danger btn-default pull-left"><span class="glyphicon glyphicon-remove" ></span>Cancel</a>
        </div>
      </div>
    </div>
  </div>
