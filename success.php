...
<div id="order" class="bg-1">
      ...
      <div class="modal-content">
        ...
        <h4>BALANCE: RM<?php echo $_SESSION['balance'];?></h4>
        <h4>PAYMENT SUCCESSFUL</h4>
            <h4>THANK YOU</h4>
        </div>
        <div class="modal-body">
              
              <a onclick="location.href='custTable.php'" class="btn btn-primary btn-lg btn-block"><span class="fa fa-chevron-left"> Continue</span></a>
        </div>
