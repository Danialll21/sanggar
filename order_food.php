        ...
        <?php
            ...
            if(isset($_POST['submit_order_food_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
                    ...
                    {
                        $stmt = $con->prepare("insert into in_order(order_id, menu_name) values(?, ?)");
			...
			<div class="select_menus_tab order_food_tab" id="menus_tab">
                ...
                <div id="message">
                    <div style="padding: 5px;">
                        <div id="inner-message" class="alert alert-danger" role="alert" style="display: none">
                            <button type="button" class="close" data-dismiss="alert" disabled>&times;</button>
				                                    	...
				                                    	<div class="select_item_bttn">
				                                    		<div class="btn-group-toggle" data-toggle="buttons">
																<label class="menu_label item_label btn btn-secondary">
																	<input type="checkbox"  name="selected_menus[]" value="<?php echo $row['menu_name'] ?>" autocomplete="off">Select
																</label>
															</div>
				                                    	</div>
				                                    <?php
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/restaurant-image.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
