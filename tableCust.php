...
<body id="sanggarBistro" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div id="about" class="container text-center">
        ...
        <div id="order" class="bg-1">
            <!-- Modal content-->
            <div class="modal-content form-row align-items-center">
                <div class="modal-header col-auto my-1">
                    <form method="POST">
                        <label for="psw" style="color: black;"><span class="fa fa-table"></span> TABLE NO.</label><br>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="table" style="color: black; font-size: 20px;" required>
...
?>
    ...
    <form action="tableCust.php" method="POST">
