  ...
  <div id="order" class="bg-1">
      ...
      <div class="modal-content">
        <div class="modal-header">
            <a onclick="location.href='profileChef.php'" class="btn btn-primary btn-lg btn-block"><span class="fa fa-user"> MY PROFILE</span></a><br>
            <a onclick="location.href='register.php'" class="btn btn-primary btn-lg btn-block"><span class="fa fa-first-order"> ADD NEW ADMIN</span></a><br>
