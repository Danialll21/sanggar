      ...
      <div>
        ...
        <div style="text-align: center">
          <form action="updateMenu.php" method="post" role="form">
            ...
            <input type="text" id="desc" name="desc" class="form-control" value="<?php echo $data['DESC_MENU'];?>">
            <label for="psw"><span class=""></span> PRICE:</label>
            <input type="text" id="price" name="price" class="form-control" value="<?php echo $data['PRICE'];?>">
              ...
              <a onclick="location.href='deleteMenu.php?NAME=<?php echo $data['ID'];?>'" class="btn btn-primary btn-lg btn-block"><span class="fa fa-trash-o"> Delete Menu</span></a>
          </form>
        </div>
        </div>
      </div>        
