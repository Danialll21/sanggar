...
$sql = "SELECT * FROM ".$_SESSION['table']." WHERE NAME ='$cartName'";    
...
$sql = "UPDATE ".$_SESSION['table']." set NAME='$cartName', QUANTITY='$cartQuantity', PRICE='$newPrice' WHERE NAME='$cartName'";
